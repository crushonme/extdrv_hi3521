...
void vdec_motion_init(void)
{
	...
	//int i = 0;
	gpio_i2c_write( NVP1918, 0xff, 0x03 );
	gpio_i2c_write( NVP1918, 0x80, 0x40 );
	gpio_i2c_write( NVP1918, 0x82, 0x40 );
	gpio_i2c_write( NVP1918, 0x84, 0x40 );
	gpio_i2c_write( NVP1918, 0x86, 0x40 );
	gpio_i2c_write( NVP1918, 0x88, 0x40 );
	gpio_i2c_write( NVP1918, 0x8a, 0x40 );
	gpio_i2c_write( NVP1918, 0x8c, 0x40 );
	gpio_i2c_write( NVP1918, 0x8e, 0x40 );

	if((vdec_mode == VDEC_NTSC)||(vdec_mode == VDEC_PAL))
	{	
#ifdef VDEC_108M
		gpio_i2c_write( NVP1918, 0x81, 0x08 );
		gpio_i2c_write( NVP1918, 0x83, 0x08 );
		gpio_i2c_write( NVP1918, 0x85, 0x08 );
		gpio_i2c_write( NVP1918, 0x87, 0x08 );
		gpio_i2c_write( NVP1918, 0x89, 0x08 );
		gpio_i2c_write( NVP1918, 0x8b, 0x08 );
		gpio_i2c_write( NVP1918, 0x8d, 0x08 );
		gpio_i2c_write( NVP1918, 0x8f, 0x08 );
#else
		gpio_i2c_write( NVP1918, 0x81, 0x48 );
		gpio_i2c_write( NVP1918, 0x83, 0x48 );
		gpio_i2c_write( NVP1918, 0x85, 0x48 );
		gpio_i2c_write( NVP1918, 0x87, 0x48 );
		gpio_i2c_write( NVP1918, 0x89, 0x48 );
		gpio_i2c_write( NVP1918, 0x8b, 0x48 );
		gpio_i2c_write( NVP1918, 0x8d, 0x48 );
		gpio_i2c_write( NVP1918, 0x8f, 0x48 );
#endif
...
void vdec_motion_display(unsigned int ch, unsigned int on)
{
	...
	if(on == 1)
	{
		gpio_i2c_write( NVP1918, 0xff, 0x01 );
		gpio_i2c_write( NVP1918, 0xc0, 0x98 );
	}
	else
	{
		gpio_i2c_write( NVP1918, 0xff, 0x01 );
		gpio_i2c_write( NVP1918, 0xc0, 0x10 );
	}

	if((vdec_mode == VDEC_NTSC) || (vdec_mode == VDEC_PAL))
	{
		gpio_i2c_write( NVP1918, 0xff, 0x02 );
		gpio_i2c_write( NVP1918, 0x12, 0x00 );
	}
	else
	{
		gpio_i2c_write( NVP1918, 0xff, 0x02 );
		gpio_i2c_write( NVP1918, 0x12, 0xff );
	}
}
...
void vdec_motion_sensitivity(unsigned int sens[16])
{
	//int i = 0;
	gpio_i2c_write( NVP1918, 0xff, 0x02 );
	gpio_i2c_write( NVP1918, 0x01, (sens[0]<<4)*2 );
